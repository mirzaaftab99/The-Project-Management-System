...
$pwd=$_SESSION['pwd'];
 ...
 ?>  
<html>
<title>Project Coordinator Home</title>
    <style>
    Body{
	padding-top:50px;
...
#nav input[type="button"]:hover{
    ...
    <form  name="myForm" method="post" action="p_co_home.php" autocomplete="off">
...
<center>
      ...
      <input type="button" onClick="location.href='gc_assign.php'" value="Group Code Allotment"><br>

      <input type="button" onClick="location.href='idea_list.php'" value="Idea List"><br>
    
    <input type="button" onClick="location.href='guide_allot.php'" value="Guide Allotment"><br>
