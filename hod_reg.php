<html>
    ...
    <form id="myForm" name="contact-form" method="post" action="hod_reg.php" autocomplete="off">
        ...
        <h2 style="color:black" align="center"><top>HOD Registration</top></h2>
     <table border="0">
         <tr>
...
if($query==1)  {
    ...
    echo'<script>alert("HOD Registration Successfully")</script>';
