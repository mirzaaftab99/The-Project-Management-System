...
$result=mysqli_query($con,$query);
    ...
    <tr>
                    ...
                    if($result1){
                        while($row1=mysqli_fetch_array($result1))
                        {
                            $group_code=$row1["group_code"];
                             $sel2="select idea1,idea2,idea3 from project_idea_topic where group_code='$group_code'";
                            $database=new DatabaseManager();
        ...
        <td rowspan="4"><?php echo $tr2[$j]["idea1"]; ?></td>
        <td rowspan="4"><?php echo $tr2[$j]["idea2"]; ?></td>
        <td rowspan="4"><?php echo $tr2[$j]["idea3"]; ?></td>
